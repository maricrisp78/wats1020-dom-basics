...
var generateFortuneCookie = function() {
	...
	var randomFortune = Math.floor((Math.random() * 51) + 1);
	fortuneText.innerHTML = fortunesList[randomFortune];
